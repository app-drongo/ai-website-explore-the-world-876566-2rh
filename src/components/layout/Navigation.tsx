        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button
              size="sm"
              className={cn(
                'group bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white',
                config.isTransparent &&
                  !isScrolled &&
                  config.lightText &&
        ...
        >
          ...
          >
            ...
            <div className="pt-4 flex flex-col space-y-2">
              ...
              <Button
                className={cn(
                  'justify-start group bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white',
                  config.isTransparent &&
                    !isScrolled &&
                    config.lightText &&
                    'bg-white text-red-600 hover:bg-white/90'
